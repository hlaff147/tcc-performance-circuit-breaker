...
\begin{itemize}
    \item \textbf{Dramatic Availability Improvement}: V2 (Circuit Breaker) achieved superior success rates in all failure scenarios, with improvements ranging from +20pp to +89pp;
    ...
    \item \textbf{No Overhead}: In Normal scenario (100\% healthy), all versions achieved 100\% success, confirming CB introduces no overhead in healthy conditions.
\end{itemize}
